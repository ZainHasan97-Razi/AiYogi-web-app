  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
      ...
      {/* {isModalOpen && ( */}
        ...
        <button className="absolute top-4 right-4 bg-red-500 text-white px-3 py-1 rounded-full hover:bg-red-600"
            onClick={()=>onClose(false)}>✕</button>
          <div className="bg-gray-800 p-6 rounded-lg text-center w-4/5 h-4/5 transform transition-transform duration-300 ease-out translate-y-10 opacity-0 animate-slide-up relative flex flex-col overflow-y-auto">

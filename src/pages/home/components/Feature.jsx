...
const Intuitive = ({name,  desc}) => {
    return (
        <div>
            <h4 className="text-lg text-textred font-semibold flex items-center gap-2">
    ...
    return (
        ...
        <div className="mt-12 flex flex-col md:flex-row items-center justify-center gap-8">
            ...
            <div className="max-w-lg">
                <h3 className="text-textred uppercase text-sm font-semibold">Features</h3>
                <h1 className="text-textwhite text-5xl font-bold">Intuitive</h1>

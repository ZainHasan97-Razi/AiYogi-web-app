    ...
    return (<>
        <section className="top-1342 py-16 px-8">
            ...
            {/* <div className="max-w-5xl mx-auto text-center"> */}
                {/* <h2 className="text-4xl font-bold text-white border-b-4 inline-block pb-2 text-center">Features</h2> */}
                <h2 className="text-4xl font-bold text-white pb-2 text-center">Features</h2>
            </div>
            <div className="mt-12 flex flex-col md:flex-row items-center justify-center gap-8">
                ...
                <div className="max-w-lg">
                    ...
                    <h2 className="text-textwhite text-4xl font-bold mb-6">Intuitive</h2>
                    <ul>
                        <li className='mb-5'>

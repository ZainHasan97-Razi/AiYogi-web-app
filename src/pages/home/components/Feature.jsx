...
const Intuitive = ({name,  desc}) => {
    return (
        <div>
            <h4 class="text-lg text-textred font-semibold flex items-center gap-2">
...
const Feature = () => {
    return (
        <>
        <section class="top-1342 py-16 px-8">
        ...
        <div class="mt-12 flex flex-col md:flex-row items-center justify-center gap-8">
            <div class="relative">
                <img src={feature1} alt="Mobile UI" class="w-3xs md:w-3xs" />
                <div class="absolute inset-0 rounded-full border border-gray-600 animate-pulse"></div>
            </div>
            <div class="max-w-lg">
                <h3 class="text-textred uppercase text-sm font-semibold">Features</h3>
                <h1 class="text-textwhite text-5xl font-bold">Intuitive</h1>
